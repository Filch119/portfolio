      ...
      <main>
        <section id="about" className="dark-section about-section centered-landing">
          ...
          <div className="profile-intro centered-hero-content">
            ...
            <Reveal delay={0.3}><div className="about-facts centered-facts"><div><span>program / level</span><strong>{profile.role}</strong></div><div><span>interests / goals</span><strong>{profile.interests[0]} and {profile.interests[2]}</strong></div><div><span>working style</span><strong>consistent, steadfast and communicative</strong></div></div></Reveal>
          </div>
